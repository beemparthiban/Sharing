...
public class ListarObjetosJogosActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        try {
            ...
            GuiUtil.exibirMsg(ListarObjetosJogosActivity.this, e.getMessage());
        }
    ...
    public void searchItem(String textToSearch) throws MindbitException {
        ...
        eventosEncontrados = (ArrayList<Objeto>) objetoNegocio.consultarNomeDescricaoParcialCategoria(id, textToSearch, Categoria.JOGOS);
    ...
    public void initList() throws MindbitException {
        eventos = objetoNegocio.listarObjetosCategorias(pessoaLogada.getId(),Categoria.JOGOS);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        Intent intent = new Intent(ListarObjetosJogosActivity.this, ObjetoActivity.class);
