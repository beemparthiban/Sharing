...
public class ListarObjetosViagemActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        try {
            ...
            GuiUtil.exibirMsg(ListarObjetosViagemActivity.this, e.getMessage());
        }
    ...
    public void searchItem(String textToSearch) throws SharingException {
        ...
        eventosEncontrados = (ArrayList<Objeto>) objetoNegocio.consultarNomeDescricaoParcialCategoria(id, textToSearch, Categoria.VIAGEM);
    ...
    public void initList() throws SharingException {
        eventos = objetoNegocio.listarObjetosCategorias(pessoaLogada.getId(),Categoria.VIAGEM);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        Intent intent = new Intent(ListarObjetosViagemActivity.this, ObjetoActivity.class);
